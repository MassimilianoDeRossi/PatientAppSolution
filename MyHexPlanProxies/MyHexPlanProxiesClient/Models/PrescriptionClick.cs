...
namespace MyHexPlanProxies.Models
{
    ...
    public partial class PrescriptionClick
    {
        ...
        /// Initializes a new instance of the PrescriptionClick class.
        /// </summary>
        public PrescriptionClick(DateTime? dateOfAdjustment = default(DateTime?), int? treatmentStepNumber = default(int?), int? sequence = default(int?), int? stageType = default(int?), IList<Strut> struts = default(IList<Strut>))
        {
            DateOfAdjustment = dateOfAdjustment;
            TreatmentStepNumber = treatmentStepNumber;
            Sequence = sequence;
            StageType = stageType;
            Struts = struts;
        }
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "TreatmentStepNumber")]
