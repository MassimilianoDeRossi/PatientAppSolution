...
Scenario: User want to change set daily time N times
	...
	When User enter 'set daily time' with '18:40'
	Then The 'set daily time' should be '6:40 PM'
	When User enter 'set daily time' with '13:02'
	Then The 'set daily time' should be '1:02 PM'
	When User enter 'set daily time' with '10:58'
	Then The 'set daily time' should be '10:58 AM'
	When User enter 'set daily time' with '23:44'
	Then The 'set daily time' should be '11:44 PM'
	When User enter 'set daily time' with '21:07'
	Then The 'set daily time' should be '9:07 PM'
	When User enter 'set daily time' with '01:33'
	Then The 'set daily time' should be '1:33 AM'
