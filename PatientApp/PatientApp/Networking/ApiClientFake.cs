...
#pragma warning disable
  ...
  */
  public class PrescriptionsMockedIndices
  {
    ...
    //public string QrCodeNino { get => @"{'Chk':'','Info':{'C':'193e3300-dbf6-4e35-90f4-231dd9d49c28','P':'8466e7fd-f2fa-4355-ae2f-2a28ad866cf9'}}"; }
    public string QrCodeNino { get => @"{'Chk':'','Info':{'C':'342611e6-00be-4dc4-a6d7-15d22d5be09d','P':'6a647063-b302-4b42-9f5e-3a899c064ef4'}}"; }

    // public string QrCodeGV { get => @"{'Chk':'','Info':{'C':'6ebbf00c-51d0-45f3-88fe-2ebdac86b59a','P':'12e77a21-f4cc-4cac-82d7-cef749e00f9e'}}"; }
