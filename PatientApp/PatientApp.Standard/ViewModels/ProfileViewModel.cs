        ...
        public ProfileViewModel(ILocalDatabaseService dbService, IApiClient apiClient, ISystemUtility sysUtility) : base(dbService, apiClient, sysUtility)
        {
            ...
            MessagingCenter.Subscribe<BaseContentPage>(this, Messaging.Messages.VIEW_APPEARING_MESSAGE, async (page) =>
            {
                if (page is ProfilePage)
                {
                    ...
                    this.SurgeonContactsInfo = await _dbService.GetSurgeonContacts();
            ...
            MessagingCenter.Subscribe<BaseViewModel>(this, Messaging.Messages.SURGEON_CONTACTS_UPDATED, async (vm) =>
            {
